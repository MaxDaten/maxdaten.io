...
image folder management, just write and publish. **Current focus:** Phase 1 - Foundation
...
- Configure SANITY_STUDIO_PROJECT_ID and SANITY_STUDIO_DATASET environment variables before running
  Studio
